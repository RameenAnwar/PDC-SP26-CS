...
#output:
  #def fibonacci(number):
#c:\Users\LAPTOP LAB\OneDrive - Higher Education Commission\Desktop\Python-Parallel-Programming-Cookbook-Second-Edition\Chapter05\asyncio_task_manipulation.py:27: DeprecationWarning: "@coroutine" decorator is deprecated since Python 3.8, use "async def" instead
  #def binomial_coefficient(n, k):
