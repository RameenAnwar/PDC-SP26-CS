...
async def state1(transition_value: int) -> str:
    """State 1 of the finite state machine"""
...
async def state2(transition_value: int) -> str:
    """State 2 of the finite state machine"""
...
async def state3(transition_value: int) -> str:
    """State 3 of the finite state machine"""
...
async def end_state(transition_value: int) -> str:
    """Final state of the finite state machine"""
